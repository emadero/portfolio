...
<body>
        ...
        <section id="sobre-mi">
            <div class="row py-sm-4 py-3">
                <div class="col-sm-7 col-12">
                    <h1>Sobre mí</h1>
                    <h2>Estudiante de Ingeniería Informática, amante del arte, la
                        escritura, y la tecnología. Enseñar es mi gran vocación</h2>
            ...
            <div class="row my-sm-4 my-3">
                ...
                <div class="col-sm-6 col-12 px-2 my-2">
                    <div class="bg-white">
                        ...
                        <div class="row p-3">
                            <div class="col-12">
                                <p>GIT, GitHub, Visual Code, Sublime, WinSCP, SSH Putty, Adobe Illustrator,MS Office,
                                    Google Docs.
                                    Trello. MS Windows, GNU/Linux, Bonita Open Solution.</p>
                            </div>
                        </div>
                    </div>
                </div>
                <div class="col-sm-6 col-12 px-2 my-2">
                    <div class="bg-white">
                        ...
                        <div class="row p-3">
                            <div class="col-12">
                                <p>Teatro Musical, Música, Deportes y Escritura.</p>
                            </div>
                        </div>
                    </div>
                </div>
    ...
    <section id="experiencia">
        <div class="container py-sm-5 py-4">
            ...
            <div class="row py-2">
                <div class="col-12 col-sm-2">
                    <h3>2018 – 2020 ITBA</h3>
                </div>
                <div class="col-12 col-sm-2">
                    <img src="images/itba.png" class="img-resposive py-3 py-sm-0" width="70" alt="itba" title="itba">
                </div>
                <div class="col-12 col-sm-8">
                    <h4> Trabajo Part-Time en la Oficina de Relaciones Internacionales. Tareas relacionadas a la
                        actualización de contenido en el campus virtual y asesoramiento a estudiantes de intercambio.
                        Retribución voluntaria por beca recibida.</h4>
                </div>
            </div>

            <div class="row py-2">
                <div class="col-12 col-sm-2">
                    <h3>2018 - 2019 TRAMA CLUB</h3>
                </div>
                <div class="col-12 col-sm-2">
                    <img src="images/TRAMA.jpg" class="img-resposive py-3 py-sm-0" width="70" alt="itba" title="itba">
                </div>
                <div class="col-12 col-sm-8">
                    <h4> Coordinador del departamento de Media. Tareas relacionadas al diseño, comunicación
                        institucional, y planificación de eventos y charlas para estudiantes universitarios.</h4>
                </div>
            </div>
            <div class="row py-2">
                <div class="col-12 col-sm-2">
                    <h3>2016 McDonald's</h3>
                </div>
                <div class="col-12 col-sm-2">
                    <img src="images/mc.png" class="img-resposive py-3 py-sm-0" width="70" alt="itba" title="itba">
                </div>
                <div class="col-12 col-sm-8">
                    <h4> Atención al cliente. Tareas relacionadas a garantizar calidad estandarizada. Manejo de Cajas.
                        Entrenador de nuevos integrantes.</h4>
                </div>
            </div>
